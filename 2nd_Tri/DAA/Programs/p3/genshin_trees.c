...
/* ---------- Domain payload ---------- */
typedef struct {
    char name[50]; // Name of the character [Eg, Diluc, Keqing, Mona, Barbra, Bennet, etc.]
    char element[20]; // Name of the element [Eg, Pyro, Hydro, Electro, Anemo, Geo, Cryo, Dendro]
    char weapon[30]; // Name of the weapon [Eg, Sword, Claymore, Polearm, Bow, Catalyst]
    int rarity; /* [Write just the number] 4 star or 5 star */
} Character;

/* create a character with his name, element, weapon and rarity */
...
// Therefore, Tree is unbalanced if BF>1 or BF<−1
