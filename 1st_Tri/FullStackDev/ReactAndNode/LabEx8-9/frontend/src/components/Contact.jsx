...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen h-auto w-full bg-gradient-to-br from-[#254252] to-[#171c2d] text-white grid place-items-center">

      <span className='flex flex-col lg:flex-row items-center justify-center gap-4 w-[94%] md:w-[65%] bg-[#171c2d] px-8 py-12 rounded-2xl shadow-xl border border-[#254252] space-y-6 '>
      
      {/* Left Image Section */}
      <div className="w-full lg:w-2/5 lg:mb-0 flex justify-center">
        <img
      ...
      <form
        ...
        className="w-full lg:w-1/2 max-w-xl flex flex-col gap-2"
      >
